...
#ifndef OPTIMO_CONTROLLER_ROS_WRAPPER_SRC_OPTIMO_API_INCLUDE_OPTIMO_API_MOVEITSERVOCALLBACK_H_
#define OPTIMO_CONTROLLER_ROS_WRAPPER_SRC_OPTIMO_API_INCLUDE_OPTIMO_API_MOVEITSERVOCALLBACK_H_
...
{
/**
 * @brief Jogs the robot using MoveIt Servo
 */
class MoveItServoCallback : public roboligent::AbstractCallback
{
public:
  /**
   ...
   *
   */
  virtual ~MoveItServoCallback() = default;
...
private:
  ...
  std::array<double, 7> trajectory_step;
