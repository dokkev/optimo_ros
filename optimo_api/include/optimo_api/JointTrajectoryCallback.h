...
#ifndef OPTIMO_CONTROLLER_ROS_WRAPPER_SRC_OPTIMO_API_INCLUDE_OPTIMO_API_JOINTTRAJECTORYCALLBACK_H_
#define OPTIMO_CONTROLLER_ROS_WRAPPER_SRC_OPTIMO_API_INCLUDE_OPTIMO_API_JOINTTRAJECTORYCALLBACK_H_
 ...
 *
 */
class JointTrajectoryCallback : public roboligent::AbstractCallback
{
public:
  /**
   ...
   */
  explicit JointTrajectoryCallback(roboligent::Model & model_, optimo::TaskQueueObject & task_);

  /**
   * @brief Destroy the MoveIt Callback object
   *
   */
  virtual ~JointTrajectoryCallback() = default;
